                        ...
                        ?>
                            ...
                            <div class="col-lg-8">
                                ...
                                <div class="property-details">
                                    ...
                                    <h5 class="mt-5 mb-4 text-secondary">Tóm tắt</h5>
                                    ...
                                    <h5 class="mt-5 mb-4 text-secondary">Đặc điểm</h5>
                                    <div class="row">
                                        <?php echo $row['17']; ?>
                                    ...
                                    <h5 class="mt-5 mb-4 text-secondary double-down-line-left position-relative">Liên hệ</h5>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-7">
                                                            <div class="row">
                                                                <div class="col-md-12 col-lg-12">
                                                                    <div class="form-group">
                                                                        <textarea class="form-control bg-gray mt-sm-20" id="massage" name="massage" cols="30" rows="7" placeholder="Gửi tin nhắn"></textarea>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
...
function GetMap()
{
    ...
    layer.add(pin)
        ...
        map.setView({ center: pinLocation, zoom: 16 });
}

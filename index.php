    ...
    <div class="row"> 
                            ...
                            <form method="post" action="#">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-6">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="city" placeholder="Nhập tên thành phố hoặc quận/huyện" required>
                                        </div>
                                    </div>
        ...
        <div class="full-row bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-secondary double-down-line text-center mb-5">Thành phố phổ biến</h2></div>
                </div>
                <div class="col-lg-12">
                    <div class="row">
